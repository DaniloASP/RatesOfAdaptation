...
effector_file <- system("ls *namesONLY.txt", intern=T) # List of effectors
Effector_df <- read.table(effector_file, sep="\t", stringsAsFactors = FALSE, header = FALSE)
genesPAV_file <- paste0({Abb_slurm},".GenePAV.txt") # List of genes in PAV (not core)
